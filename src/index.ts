 ...
 *
 * Seven ideas, each in its own module under `./core`, none of them coupled to
 ...
 *   - `decision-hygiene`   is the decision behind a bypass itself still current
...
export * from './core/decision-hygiene'
